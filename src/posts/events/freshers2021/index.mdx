...
import { freshers2021table, logoCell, freshers2020freshershacklogo, noBottom } from "./index.module.scss";
...
>
  <table className={freshers2021table}>
    <tbody>
      ...
      <tr>
        <td>Monday 27</td>
        <td>Whatever Social Chelmsford</td>
        <td>6pm</td>
      </tr>
      <tr>
        <td>Tuesday 28</td>
        <td>Something Else Slough</td>
        <td>25pm</td>
      </tr>
      <tr>
        <td>Wednesday 29</td>
